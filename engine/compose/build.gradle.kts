...
kotlin {
    ...
    android {
        ...
        // the engine touches no API past 26, so apps on an older compileSdk
        // keep resolving it. Without this, AGP stamps minCompileSdk = 36
        // into the AAR and every such app fails to build.
        aarMetadata {
            minCompileSdk = 26
        }
    }
